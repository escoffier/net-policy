 ...
 *the epoll thread via queue_, and blocks until DispatchGrpcControlOp
...
grpc::Status ControlServiceImpl::EnqueueAndWait(ControlOp op, const google::protobuf::Message& request,
