...
static int nfct_parse_ip_attr_cb(const struct nlattr *attr, void *data)
{
...
int nfct_parse_tuple(const struct nlattr *attr, struct __nfct_tuple *tuple,
...
int nfct_payload_parse(const void *payload, size_t payload_len,
